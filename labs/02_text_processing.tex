...
\begin{quote}
    ...
    \textbf{Note 2:} After completing the exercise, considering the same retrieval problem, you can also experiment with the application of the BM25 model that was introduced in the theoretical lecture, considering $b=0.75$ and $k_1=1.2$.
\end{quote}
