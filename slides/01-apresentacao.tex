...
\begin{frame} 
    ...
    \begin{block}{Professores}
        \begin{itemize}
        \item<1>[] \includegraphics<1>[scale=0.5]{photo-ist14497} Pável Calado (responsável)
        \item<1>[] \includegraphics<1>[scale=0.5]{photo-ist24686} Bruno Martins
        \item<1>[] \includegraphics<1>[scale=0.5]{photo-ist170599} João Monteiro
        \item<1>[] \includegraphics<1>[scale=0.5]{photo-ist191486} Danielle Vieira
        \item<2>[] \includegraphics<2>[scale=0.5]{photo-ist14497-alt} Pável Calado (responsável)
        \item<2>[] \includegraphics<2>[scale=0.5]{photo-ist24686-alt} Bruno Martins
        \item<2>[] \includegraphics<2>[scale=0.5]{photo-ist170599-alt} João Monteiro
        \item<2>[] \includegraphics<2>[scale=0.5]{photo-ist191486-alt} Danielle Vieira
	\end{itemize}
    \end{block}
