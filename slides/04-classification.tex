...
\begin{frame} \frametitle{Problems of Simple Perceptrons}
\begin{block}{}
\begin{itemize}
...
\begin{block}{}
\begin{itemize}
\item Several problems involve multi-class classification
\item Multi-class classification requires one weight vector for each category
...
\item Other options for the update rule can be considered, e.g. updating all classes that have higher score from the correct one 
\end{itemize}
\end{block}
\end{frame}
