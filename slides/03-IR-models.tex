...
\begin{array}{lll}
	P(q|d) &=& \prod_{1<=i<=|q|} \left( \alpha \times P(t_i|d) \right) + \left( (1-\alpha) \times P(t_i|c) \right) \\
           &=&  \prod_{1<=i<=|q|} \left( \alpha \times P(t_i|d) \right) + \left( (1-\alpha) \times P(t_i|c) \right) \times \frac{(1-\alpha) \times P(t_i|c)}{(1-\alpha) \times P(t_i|c)} \\
		   
		   &=&  \prod_{1<=i<=|q|} \left( \frac{\left( \alpha \times P(t_i|d) \right)} {\left( (1-\alpha) \times P(t_i|c) \right)} + 1 \right) \times (1-\alpha) \times P(t_i|c) \\
\end{array}
\end{equation*}
