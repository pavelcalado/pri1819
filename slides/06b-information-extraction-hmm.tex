...
\begin{frame} \frametitle{Structured Perceptron (just a hint)}
 ...
 \begin{frame}
     \frametitle{Linear-Chain Conditional Random Fields (just a hint)}
     \centering
     ...
     \item Infering the parameters by maximum likelihood learning, e.g., through gradient descent algorithms
     \begin{itemize}
\end{frame}
